...
#                     "original": "teh",
#                     "corrected": "the",
#                     "explanation": "拼写错误。" if native_language != "ko" else "맞춤법 오류입니다。",
#                 }
#             )
#         if "adn" in content:
#             corrections.append(
...
#         explanation = (
#             f"总的来说是一篇不错的写作。总分{overall_score}分。"
#             f"语法{grammar_score}分，词汇{vocabulary_score}分，连贯性{coherence_score}分。"
#             f"修正一些小错误会让写作更加完美。"
#             if native_language != "ko"
#             else f"전반적으로 좋은 작문입니다. 전체 점수 {overall_score}점을 받았습니다. "
#             f"문법은 {grammar_score}점, 어휘는 {vocabulary_score}점, 일관성은 {coherence_score}점입니다. "
#             f"몇 가지 작은 오류를 수정하면 더욱 완벽한 작문이 될 것입니다."
#         )
...
#     print("=" * 60)
#     print("🚀 WriteFlow Server Starting...")
#     print("📝 AI English Writing Correction Platform")
#     print(f"🌐 Listening on port: {PORT}")
#     print("✅ Supports both local & Render environments")
#     print("=" * 60)
